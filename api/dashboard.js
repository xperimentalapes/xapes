...
const DASHBOARD_API = /^\/api\/(discord|discord-rewards|verify|collections|holders|prices|xma-ohlc|blunana-ohlc|coinflip-state|coinflip-stats|coinflip-flip|coinflip-purchase|coinflip-collect|coinflip-confirm-collect|holder-link-wallet|holder-verify|cron\/accrue-xma|cron\/settle-xma|cron\/sync-nfts|spin-slots|spin-roulette|record-game-purchase|open-chest|confirm-chest-collect|collect-chest|collect|confirm-collect|load-player|leaderboard|game-stats|save-game|consume-chest-open|chest-opens|reserve-chest-prize|record-chest-purchase)(\/|$|\?)/;
