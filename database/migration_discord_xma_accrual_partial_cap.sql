-- Fix daily-cap overflow: credit partial amounts and mark capped events as credited
-- so settlement does not delete uncredited engagement rows.
-- Run after migration_discord_xma_daily_settlement.sql.
