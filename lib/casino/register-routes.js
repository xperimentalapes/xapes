...
function registerCasinoRoutes(app) {
  ...
  app.post('/api/open-chest', h(require(path.join(dir, 'open-chest.js'))));
  app.post('/api/confirm-chest-collect', h(require(path.join(dir, 'confirm-chest-collect.js'))));
  app.post('/api/collect-chest', h(require(path.join(dir, 'collect-chest.js'))));
  ...
  app.post('/api/consume-chest-open', h(require(path.join(dir, 'consume-chest-open.js'))));
  app.get('/api/chest-opens', h(require(path.join(dir, 'chest-opens.js'))));
  app.post('/api/reserve-chest-prize', h(require(path.join(dir, 'reserve-chest-prize.js'))));
  app.post('/api/record-chest-purchase', h(require(path.join(dir, 'record-chest-purchase.js'))));
}
